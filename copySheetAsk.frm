VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} copySheetAsk 
   Caption         =   "Copy System for Template or Project"
   ClientHeight    =   1740
   ClientLeft      =   108
   ClientTop       =   456
   ClientWidth     =   4944
   OleObjectBlob   =   "copySheetAsk.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "copySheetAsk"
...
Private Sub UserForm_Initialize()
    ...
    With ComboBox1
        .Clear
        For i = 5 To n
            .AddItem ActiveWorkbook.Worksheets("DATA_HOLD").Cells(i, 12).Value
        Next i
    End With
